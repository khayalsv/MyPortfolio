        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Live = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ability1 = table.Column<int>(type: "int", nullable: false),
                    Name2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ability2 = table.Column<int>(type: "int", nullable: false),
                    Name3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ability3 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
